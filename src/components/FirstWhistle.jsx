...
const FirstWhistle = () => {
    ...
    return (
        <div ref={containerRef} className="relative w-full max-w-6xl mx-auto min-h-[50vh] pt-24 pb-8 md:py-32 px-4 md:px-8 z-10 flex flex-col gap-16 md:h-[1700px] md:block">
